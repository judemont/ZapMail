  ...
  return (
    <div className="flex-1 flex flex-col bg-white overflow-hidden">
      <div className="border-b border-gray-200 px-6 py-4 flex items-center space-x-4 flex-shrink-0">
        ...
        <h2 className="text-xl font-semibold text-gray-800">Support ZapMail</h2>
      </div>

      <div className="flex-1 overflow-y-auto p-6">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-3">Support the Future of Email</h1>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl p-6 mb-6">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Instant, low-fee donations</p>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition flex items-center space-x-2 flex-shrink-0"
                  >
                    {copied === 'lightning' ? (
                      <>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-xl p-6 mb-6">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900">Bitcoin On-Chain</h2>
              </div>
            </div>
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    readOnly
                    className="flex-1 px-4 py-2 border border-gray-300 rounded-lg bg-white font-mono text-sm break-all"
                  />
                  <button
                    onClick={() => copyToClipboard(onchainAddress, 'onchain')}
                    className="px-4 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition flex items-center space-x-2 flex-shrink-0"
                  >
                    {copied === 'onchain' ? (
                      <>
                        <Check className="w-4 h-4" />
